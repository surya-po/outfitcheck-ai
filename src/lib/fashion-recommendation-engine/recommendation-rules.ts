...
export const personaStyleDescriptions: Record<FashionPersonaType, string> = {
  ...
  "Elegant Casual": "perpaduan elegan dan kasual yang berkelas namun tetap nyaman",
  "Modest Fashion": "tampilan sopan dan tertutup yang mengedepankan keanggunan",
  "Office Wear": "tampilan profesional yang rapi dan elegan untuk lingkungan kerja",
