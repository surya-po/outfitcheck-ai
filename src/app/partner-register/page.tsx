        ...
        <div className="bg-card border border-border/60 rounded-[var(--radius-card)] shadow-lg p-6 sm:p-8">
          ...
          <form action={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="boutiqueName">Nama Butik</Label>
              <Input
                id="boutiqueName"
                name="boutiqueName"
                type="text"
            ...
            <div className="space-y-2">
              <Label htmlFor="partner-email">Email Admin</Label>
              <Input
                id="partner-email"
                name="email"
                type="email"
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-card px-3 text-muted-foreground">atau daftar cepat dengan</span>
            </div>
          </div>
