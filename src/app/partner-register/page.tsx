...
export default function PartnerRegisterPage() {
  ...
  async function handleSubmit(formData: FormData) {
    ...
    startTransition(async () => {
      const result = await signUpAsPartner(formData);
      if (result?.error) {
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[var(--radius-card)] shadow-2xl p-8 space-y-8">
          ...
          <form action={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              <label htmlFor="boutiqueName" className="block text-sm font-medium text-gray-300">
                Nama Butik
              </label>
              <input
                id="boutiqueName"
                ...
                type="text"
                required
                placeholder="Fashion House Jakarta"
          ...
          <div className="relative mt-2">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#1F2937] px-3 text-gray-400">atau daftar cepat dengan</span>
            </div>
          </div>
          ...
          <div className="relative mt-2">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#1F2937] px-3 text-gray-400">sudah punya butik?</span>
            </div>
          </div>
