    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8 space-y-8">
          ...
          {/* Alert Message */}
          {message && (
            <div className={`flex items-start gap-3 border rounded-xl p-4 text-sm animate-in fade-in-50 duration-200 ${
          ...
          {message?.type !== "success" ? (
            ...
            <Link
              href="/partner-login"
              className="w-full py-3 px-4 bg-pink-500 hover:bg-pink-600 text-white font-semibold rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow-lg shadow-pink-500/20"
            >
              Lanjutkan ke Login
            </Link>
          )}
