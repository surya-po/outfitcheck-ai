...
export default async function HistoryPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-heading font-bold text-foreground tracking-tight">Riwayat Scan</h1>
        <p className="text-sm text-muted-foreground mt-1">Kelola dan tinjau kembali profil fashion AI Anda sebelumnya.</p>
      </div>
