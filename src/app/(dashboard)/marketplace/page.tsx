...
export default async function MarketplacePage(
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in-50 duration-500 pb-12">
      {/* Header / Hero Banner */}
      {isDefaultView && (
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-pink-500 to-rose-400 p-8 sm:p-12 text-white shadow-lg border border-pink-400/50">
          <div className="relative z-10 max-w-2xl space-y-4">
            <Badge className="bg-white/20 hover:bg-white/30 text-white border-none px-3 py-1 text-xs">
          ...
          <div className="absolute bottom-0 right-1/4 translate-y-1/2 w-48 h-48 bg-rose-300/30 rounded-full blur-2xl"></div>
      ...
      <div className="sticky top-0 z-20 pt-2 pb-4 bg-[#F8F9FA]/80 backdrop-blur-xl">
        <Suspense fallback={<div className="h-12 bg-white/50 animate-pulse rounded-full" />}>
          <MarketplaceFilter />
        </Suspense>
      </div>
