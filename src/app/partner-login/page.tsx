    ...
    <div className="min-h-screen bg-muted flex items-center justify-center p-4 sm:p-8">
      ...
      <div className="relative w-full max-w-[440px]">
        ...
        <div className="bg-card border border-border/60 rounded-[var(--radius-card)] shadow-lg p-6 sm:p-8">
          {error && (
            <div className="flex items-start gap-3 bg-destructive/10 border border-destructive/20 text-destructive rounded-[var(--radius-button)] p-4 text-sm mb-6 animate-in fade-in-50 duration-200">
          ...
          <form action={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="partner-email">Email Butik</Label>
              <Input
                id="partner-email"
                name="email"
                type="email"
            ...
            <div className="flex items-center justify-between pt-1">
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="partner-remember" className="text-sm text-muted-foreground cursor-pointer">
                  Ingat saya
                </label>
              </div>
              <Link
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-card px-3 text-muted-foreground">atau masuk dengan</span>
            </div>
          </div>
          ...
          <Button
            ...
            disabled={isLoading}
            className="w-full h-12 bg-background hover:bg-muted font-semibold"
          >
            {isGooglePending ? (
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-muted-foreground">
              Tertarik bergabung dengan Partner Program?{" "}
