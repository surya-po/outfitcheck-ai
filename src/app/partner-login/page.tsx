...
function PartnerLoginForm() {
  ...
  async function handleGoogleLogin() {
    ...
    try {
      const result = await signInWithGooglePartner();
      if (result?.error) {
        setError(result.error);
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[var(--radius-card)] shadow-2xl p-8 space-y-8">
          ...
          <form action={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-sm text-pink-400 hover:text-pink-300 transition-colors hover:underline underline-offset-2"
              >
                Lupa password?
              </Link>
            </div>
            ...
            >
              {isPending ? (
                ...
                <span>Masuk ke Partner Portal</span>
              )}
            </button>
          </form>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#1F2937] px-3 text-gray-400">atau masuk dengan</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full py-3 px-4 bg-white hover:bg-gray-50 border border-gray-200 disabled:opacity-60 disabled:cursor-not-allowed text-gray-700 font-semibold rounded-[var(--radius-button)] transition-all duration-200 flex items-center justify-center gap-3 shadow-sm"
          >
            {isGooglePending ? (
              ...
              <>
                ...
                <span>Google Partner Login</span>
              </>
            )}
          </button>
          ...
          <div className="relative mt-2">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#1F2937] px-3 text-gray-400">belum punya akun butik?</span>
            </div>
          </div>
